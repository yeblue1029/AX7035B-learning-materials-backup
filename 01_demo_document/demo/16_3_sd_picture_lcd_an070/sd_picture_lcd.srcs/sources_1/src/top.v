...
wire                            init_calib_complete;     //MIG initialization compelete
...
/*************************************************************************
Generate lcd screen backlight adjustment
****************************************************************************/
...
/****
/*************************************************************************
Video timing control and data generation module
****************************************************************************/
video_timing_data#(
...
.read_len                       (25'd192000               ), //frame size 1024 * 768 * 32 / 64
.read_en                        (read_en                  ),
.read_data                      (read_data                ),
...
.write_len                      (25'd192000               ), //frame size
.write_en                       (write_en                 ),
.write_data                     (write_data               )
);
/*************************************************************************
