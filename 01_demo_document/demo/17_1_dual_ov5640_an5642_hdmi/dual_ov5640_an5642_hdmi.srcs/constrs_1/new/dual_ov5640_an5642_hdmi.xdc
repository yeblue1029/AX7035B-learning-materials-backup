...
set_false_path -from [get_clocks clk_pll_i] -to [get_clocks cmos1_pclk]
...
set_false_path -reset_path -from [get_clocks -of_objects [get_pins u_ddr3/u_ddr3_mig/u_ddr3_infrastructure/gen_mmcm.mmcm_i/CLKFBOUT]] -to [get_clocks cmos2_pclk]
