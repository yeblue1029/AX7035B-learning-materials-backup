...
set rc [catch {
  ...
  add_files -quiet G:/ax7035b/vivado/30_video_ethernet/video_ethernet/video_ethernet.runs/synth_1/video_ethernet.dcp
  ...
  link_design -top video_ethernet -part xc7a35tfgg484-2
