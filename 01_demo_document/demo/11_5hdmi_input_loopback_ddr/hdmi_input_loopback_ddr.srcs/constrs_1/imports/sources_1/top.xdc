...
#  set_property IOSTANDARD LVTTL [get_ports TMDS_clk_hdmi_out_n]
#  set_property PACKAGE_PIN D1 [get_ports TMDS_clk_hdmi_out_n]
 
# set_property PACKAGE_PIN E1 [get_ports TMDS_clk_hdmi_out_p]
# set_property IOSTANDARD LVTTL [get_ports TMDS_clk_hdmi_out_p]
 
# set_property IOSTANDARD LVTTL [get_ports {TMDS_data_hdmi_out_n[0]}]
# set_property PACKAGE_PIN F1 [get_ports {TMDS_data_hdmi_out_n[0]}]
 
# set_property PACKAGE_PIN G1 [get_ports {TMDS_data_hdmi_out_p[0]}]
# set_property IOSTANDARD LVTTL [get_ports {TMDS_data_hdmi_out_p[0]}]
 
# set_property IOSTANDARD LVTTL [get_ports {TMDS_data_hdmi_out_n[1]}]
# set_property PACKAGE_PIN G2 [get_ports {TMDS_data_hdmi_out_n[1]}]
  
# set_property PACKAGE_PIN H2 [get_ports {TMDS_data_hdmi_out_p[1]}]
# set_property IOSTANDARD LVTTL [get_ports {TMDS_data_hdmi_out_p[1]}]
 
# set_property IOSTANDARD LVTTL [get_ports {TMDS_data_hdmi_out_n[2]}]
# set_property PACKAGE_PIN J1 [get_ports {TMDS_data_hdmi_out_n[2]}]
 
# set_property PACKAGE_PIN K1 [get_ports {TMDS_data_hdmi_out_p[2]}]
# set_property IOSTANDARD LVTTL [get_ports {TMDS_data_hdmi_out_p[2]}]
