//wm8731中寄存器的配置程序
 module phy_reg_config(
					 ...
					 output reg phy_rst_n,
					  (* MARK_DEBUG="true" *)output [15:0] phy_reg,
					 output phy_mdc,
					 inout phy_mdio,
					 output reg phy_init
					);
...
reg [1:0]config_step;
(* MARK_DEBUG="true" *)reg [3:0]reg_index;
						  ...
						  0:begin
							...
							2:begin
							  ...
							  if(reg_index==12) begin              
 							    if(phy_reg[2]==1'b0)             //如果not link up	,等待     
							      reg_index<=reg_index;           
							    else 
...
begin
        ...
        10:reg_data<=24'h0e0000; 		  //Reg14 =0x0000(disable EEE) 
		  ...
		  12:reg_data<=24'h010000; 		  //Reg01 read phy register
		  13:reg_data<=24'h1F0000; 		  //Reg11 read phy register
     //  default:reg_data<=24'h110000;
     default:reg_data<=24'h1F0000;
      endcase
end
...
//assign  TRIG0[15:0]=phy_reg;  
//assign  TRIG0[16]=phy_init;  
//assign  TRIG0[17]=if_read;
//assign  TRIG0[18]=phy_mdio;
//assign  TRIG0[19]=phy_mdc;
