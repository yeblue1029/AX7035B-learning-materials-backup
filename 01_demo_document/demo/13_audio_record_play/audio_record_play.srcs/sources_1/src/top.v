...
wire[9:0]                        lut_index;              //Lookup table index
wire[31:0]                       lut_data;               //Lookup table data

wire                             ui_clk;                 //MIG output clock
wire                             ui_clk_sync_rst;        //MIG reset output
wire                             init_calib_complete;    //MIG initialization flag
...
/*************************************************************************
Recording and audio playback control
****************************************************************************/
