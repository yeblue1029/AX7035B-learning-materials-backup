...
set rc [catch {
  ...
  add_files -quiet I:/ax7035_2019.1/demo/08_ram_test/ram_test.runs/synth_1/ram_test.dcp
  ...
  link_design -top ram_test -part xc7a35tfgg484-2
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file ram_test_timing_summary_routed.rpt -pb ram_test_timing_summary_routed.pb -rpx ram_test_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file ram_test_bus_skew_routed.rpt -pb ram_test_bus_skew_routed.pb -rpx ram_test_bus_skew_routed.rpx"
