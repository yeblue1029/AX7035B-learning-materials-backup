...
.rd_en                       (wr_burst_data_req       ),     //read enable  
.dout                        (wr_burst_data           ),     //output data 
.full                        (                        ),
.empty                       (                        ),
.rd_data_count               (rdusedw                 ),     //read data count
.wr_data_count               (                        )
);
/*************************************************************************
Write fixed length data to DDR address area block
****************************************************************************/
frame_fifo_write
#
(
...
.wr_en                       (rd_burst_data_valid     ),     //Write enable               
.rd_en                       (read_en                 ),     // Read enabl               
.dout                        (read_data               ),     //output data                   
.full                        (                        ),                   
.empty                       (                        ),                 
.rd_data_count               (                        ), 
.wr_data_count               (wrusedw                 )      // Write data count
);
/*************************************************************************
Read fixed length data from DDR address area block
****************************************************************************/
frame_fifo_read
#
(
