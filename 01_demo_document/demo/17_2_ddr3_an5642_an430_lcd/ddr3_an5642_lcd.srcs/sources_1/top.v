...
****************************************************************************/
lut_ov5640_rgb565_480_272 lut_ov5640_m0
(
.lut_index                      (cmos1_lut_index          ),
...
****************************************************************************/
lut_ov5640_rgb565_480_272 lut_ov5640_m1
(
.lut_index                      (cmos2_lut_index          ),
...
.read_addr_index                (read_addr_index           ),
.read_len                       (24'd32640                 ),//frame size  480 * 272 * 16 / 64
.read_en                        (read_en                   ),
.read_data                      (read_data                 ),
...
.write_addr_index               (write_addr_index          ),
.write_len                      (24'd32640                 ),//frame size  480 * 272 * 16 / 64
.write_en                       (write_en                  ),
