...
.probe5     (buf_wr         ), // input wire [0:0]  probe5 ft_data
.probe6     (buf_rd         ), // input wire [0:0]  probe6 ft_data
.probe7     (buf_data       ), // input wire [0:0]  probe7 ft_data
.probe8     (ft_data_out    ), // input wire [0:0]  probe8 ft_data
.probe9     (state          ), // input wire [0:0]  probe9 ft_data
.probe10    (buf_empty      ), // input wire [0:0]  probe10 ft_data
.probe11    (rd_data_count  ), // input wire [0:0]  probe11 ft_data
.probe12    (wr_data_count  ), // input wire [0:0]  probe12 ft_data
.probe13    (ft_clk         ) // input wire [0:0]  probe13 ft_data
 );                 
endmodule